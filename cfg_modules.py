...
PYTOOLS_MODULES = ['imageiter', 'nimageiter', 'numcombine', 'versioninfo', 'makewcs', 'irafglob', 'parseinput','iterfile', 'fitsdiff', 'readgeis', 'fileutil', 'wcsutil','linefit', 'nmpfit', 'gfit', 'xyinterp']
