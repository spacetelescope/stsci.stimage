...
class ObjectList:
    ...
    def buildObjectlist(self, image, slices=None):
        ...
        for region in _s:
            ...
            _edge = edges[region]
            _img = image[region]
            print '[objectlist] starting refcount for _img: ',sys.getrefcount(_img)
            print '[objectlist] starting refcount for _edge: ',sys.getrefcount(_edge)
            ...
            n = 0
            print '[objectlist] number of objects found: ',len(wobjs)
            for wn in wobjs:
            ...
            print '[objectlist] refcount for _img: ',sys.getrefcount(_img)
            print '[objectlist] refcount for _edge: ',sys.getrefcount(_edge)
            
            del wlabels,nobjs,wobjs,_edge,_img
        print '[objectlist] refcount for image: ',sys.getrefcount(image)
