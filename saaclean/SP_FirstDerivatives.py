...
# library by Karl Hinsen. Only the DerivVector definition was
# commented out since this application doesn't use it, to avoid
...
#----------------------------------------------------------------------
#Commented out in this version to avoid further imports
#----------------------------------------------------------------------
